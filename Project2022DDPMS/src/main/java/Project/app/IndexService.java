...
public class IndexService {
	...
	// 		}
	// 	} catch (IOException e) {
    //         System.out.println("error1111111111111111error11111111111111111111111111111error111111111111111111111111111111111111111111");
	// 		e.printStackTrace();
	// 	}
    // }
    ...
    public ArrayList<String> ViewIndexOurs(String indexName, String indexValue, int logNumber) {
        ...
        // MatchQueryBuilder matchQueryBuilder = new MatchQueryBuilder(indexName, indexValue);
